...
setup(name='docassemble.MANoticeOfAppearanceForm',
      ...
      author_email='Landon.Shimel@su.suffolk.edu',
      ...
      zip_safe=False,
      package_data=find_package_data(where='docassemble/MANoticeOfAppearanceForm/', package='docassemble.MANoticeOfAppearanceForm'),
     )
